...
I designed puzzle systems, digitally painted worldbuilding assets, and created graphics for reproducible in-world newspaper and journal entries that could be printed and fabricated by sign shops for durable outdoor gameplay.

<div class="finder-gallery-grid">
  <button class="finder-gallery-item" type="button" data-gallery-item data-gallery-src="/assets/escapeindustries/TheMysticHowler_ENH.png" data-gallery-title="The Mystic Howler Newspaper">
    <img src="/assets/escapeindustries/TheMysticHowler_ENH.png" alt="The Mystic Howler Newspaper">
  </button>
  <button class="finder-gallery-item" type="button" data-gallery-item data-gallery-src="/assets/escapeindustries/MainCharacterNewspaperArticle.PNG" data-gallery-title="Journal Entry Concept">
    <img src="/assets/escapeindustries/MainCharacterNewspaperArticle.PNG" alt="Journal Entry Concept">
  </button>
  <button class="finder-gallery-item" type="button" data-gallery-item data-gallery-src="/assets/escapeindustries/GlyphGuide_EscapeNewHaven_JadenAndrea.png" data-gallery-title="Glyph Guide Digital Painting">
    <img src="/assets/escapeindustries/GlyphGuide_EscapeNewHaven_JadenAndrea.png" alt="Glyph Guide Digital Painting">
  </button>
</div>
